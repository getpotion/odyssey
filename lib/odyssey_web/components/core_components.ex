defmodule OdysseyWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(OdysseyWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(OdysseyWeb.Gettext, "errors", msg, opts)
    end
  end
